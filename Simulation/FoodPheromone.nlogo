globals     [name nest-color time food-color  currentSim FoodPheromeonRecord] ;; setting global variables (description below)
...
to go
  ...
  file-open (word "Food pheromone record " time ".csv")
   record-condition
