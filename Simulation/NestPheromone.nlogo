globals     [name nest-color time food-color  currentSim NestPheromeonRecord] ;; setting global variables (description below)
...
to setup
  ...
  clear-all
  file-close-all
  set-current-directory "" ; set whatever directory you want to save the files here
  ;carefully [
...
to go
  ...
  file-open (word "Nest pheromone record " time ".csv")
   record-condition
   file-print (word "Tick Marks," "x," "y," "Pheromone amount")
   reset-ticks
